# SILENT MEDIC VET — knowledge base v0.1.9
...
# ───────── TIER 5 · HOLISTIC / INTEGRATIVE (v0.1.9) — dog and horse ─────────
_OUT_H={k:{"s":"no","n":"Outside the scope of this card (dog and horse only)."} for k in ["cat","rabbit"]} | {k:{"s":"no","n":"Outside the scope of this card (dog and horse only). Herbal products in food animals need a FARAD withdrawal.","w":"n/a — reference card"} for k in FOOD}
add(n="Holistic / integrative veterinary medicine — dog and horse",a=["holistic","integrative","CAVM","complementary","homeopathy","TCVM","whole-animal","natural"],tier=5,cls="Integrative care framework (veterinarian only in TX)",rx="proc",
 ind=["holistic","integrative","chronic pain","osteoarthritis","quality of life","geriatric","cancer support","wellness","alternative"],ev="C",
 evn="'Holistic' is not one treatment: it is a framework combining conventional care with complementary modalities. Evidence must be judged modality by modality — acupuncture and rehabilitation have controlled data (see their cards); herbal/TCVM formulas mostly extrapolated or anecdotal (C–D); veterinary homeopathy: meta-analysis of 15 placebo-controlled trials found only two of reliable quality and 'very limited evidence' (D). A 2016 multi-college consensus defines integrative veterinary medicine as complementary therapies used alongside conventional care and guided by the best available evidence.",
 sp={"dog":{"s":"caution","d":"Plan built by a veterinarian: conventional diagnosis and treatment first, then complementary modalities chosen by evidence grade — rehabilitation (B), acupuncture (B), omega-3 and weight management (A–B), herbal/TCVM (C–D)","n":"Texas 573.16: veterinarian only; conventional options disclosed; signed alternate-therapy acknowledgment in the record."},
     "horse":{"s":"caution","d":"Same structure; add controlled exercise, farriery and manual therapy (C) as indicated; herbal products carry competition (FEI/USEF) risk","n":"Texas 573.16 as for dog. Many 'natural' equine supplements contain prohibited substances — check the FEI list before competition."}} | _OUT_H,
 owner="Holistic (integrative) care means a veterinarian combines normal medicine with things like rehabilitation, acupuncture, diet and some herbs — it is not a replacement for diagnosis, surgery or needed drugs. Some of these have real evidence (rehab, acupuncture, fish oil, weight loss); herbs mostly do not; homeopathy has essentially none. In Texas only a licensed veterinarian may provide holistic or homeopathic treatment, and they must tell you the conventional options first and have you sign a form.",
 dvm="Use the framework, grade each component. Order: diagnosis → conventional standard of care → complementary modalities added for pain, mobility, appetite, quality of life, chosen by this app's evidence grade and documented with objective outcome measures. Do not let 'holistic' become a reason to omit imaging, analgesia or surgery — that is where liability lies. Herb–drug interactions (St John's wort, garlic, ginkgo, turmeric with anticoagulants/NSAIDs) and product-quality variability are the recurring harms; homeopathic products are pharmacologically inert but delay effective treatment. Texas 22 TAC 573.16: veterinarian only, no delegation; disclose conventional treatments and their probable ability to cure; signed owner acknowledgment kept permanently. Evidence grade C reflects the framework as a whole; individual modality cards carry their own grade.",
 reg="22 TAC 573.16 (acupuncture, holistic medicine, homeopathy — veterinarian only, disclosure and signed acknowledgment); AVMA Guidelines for Complementary and Alternative Veterinary Medicine.",
 comp="Herbal and 'natural' supplements: check FEI/USEF prohibited-substance lists; positives from botanical products are documented.",
 refs=["Memon MA, Shmalberg J, Adair HS, et al. Open Vet J. 2016;6(1):44-56. PMID 27200270",
       "Mathie RT, Clausen J. Homeopathy. 2015;104(1):3-8. PMID 25576265"],
 rf="Any animal getting worse under a holistic-only plan — weight loss, unrelenting pain, a mass that is growing — needs conventional work-up now, not another remedy.")
